...
<head>
    ...
    <link rel = "shortcut icon" type = "image/jpg" href = "pic/PlaneIamge2.jpg" >
    ...
    <style>
        ...
        .bgimg-1 {
            ...
            background-image: url("pic/PlaneIamge2.jpg");
            min-height: 100%;
        }
        .w3-bar .w3-button {
            padding: 16px;
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
            <form method="post" action="${pageContext.request.contextPath}/ShowBookings.jsp">
